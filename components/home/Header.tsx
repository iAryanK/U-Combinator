...
const Header = () => {
    return (
        <div className="h-[80vh] w-full relative flex items-center pt-24 flex-col gap-2">
            <div
                className="absolute top-0 z-[-2] h-full w-full bg-transparent dark:bg-neutral-950 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]"/>
